...
const mindmapGeneratorPrompt = "Напишите дорожную карту для изучения предмета, дайте мне только подсказку без комментариев:\n\nВы эксперт по предмету. Ваша задача — создать самую полную дорожную карту обучения, когда-либо созданную в истории человечества по [НАВЫКУ/ПРОФЕССИИ/ПРЕДМЕТУ].\n\nДумайте об этой дорожной карте как о своего рода «загрузке знаний», как в «Матрице».\n\nФормат вывода:\n\nКорневое поле: topic — это основная тема.\n\nВетки: branches, каждая с полем title и массивом children.\n\nМаксимальная глубина: 6 уровней (узел может содержать подузлы, и так до 6 вложенных уровней).\n\nВывод строго в валидном JSON, без пояснений и форматирования.\n\nВключите элементы из [НАУК, КОТОРЫЕ ВАМ НУЖНЫ, ЧТОБЫ СТАТЬ ПРОФИ]\n\nВключите [КАКИЕ ЖЕСТКИЕ И МЯГКИЕ НАВЫКИ ВАМ НУЖНЫ].\n\nОтноситесь к дорожной карте как к практической энциклопедии по изучению: каждый пункт должен быть достаточно понятным, чтобы его можно было искать и изучать независимо.\n\nЦелевая аудитория — люди, которые хотят полностью освоить [ПРЕДМЕТ].\n\nВажно: не обобщайте. Не упрощайте. Ничего не упускайте. Углубляйтесь в каждый пункт. Это будет окончательный список по изучению [СФЕРА/ПРОФЕССИЯ].";
